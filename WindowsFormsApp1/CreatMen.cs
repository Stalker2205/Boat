...
namespace WindowsFormsApp1
{
    public partial class CreatMen : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                this.salesPersonTableAdapter.creatManager(dbBoatDataSet.SalesPerson, passwordTextBox.Text, loginTextBox.Text,Convert.ToInt32( salesPersonIDTextBox.Text));
                ...
                try
                {
                    Convert.ToInt32(salesPersonIDTextBox.Text);
                }catch { MessageBox.Show("id должно быть числом");return; }
                this.salesPersonTableAdapter.InsertQuery(Convert.ToInt32(salesPersonIDTextBox.Text), firstNameTextBox.Text, familyNameTextBox.Text, loginTextBox.Text, passwordTextBox.Text, comboBox1.Text, DateTime.Now, "Активна");
